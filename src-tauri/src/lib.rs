...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            workspaces::editor_open,
            workspaces::editor_close,
            workspaces::editor_snapshot,
            workspaces::editor_read_range,
            workspaces::editor_apply_delta,
            workspaces::editor_search_in_buffer,
            workspaces::editor_flush_to_disk,
            workspaces::editor_reload_from_disk,
