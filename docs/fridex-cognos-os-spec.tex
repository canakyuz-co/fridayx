...
% FridayX preview uses a bundled LaTeX engine (often Tectonic) that may not have
% system font discovery available. Using `fontspec` with named fonts is therefore
% brittle. Instead we stick to classic LaTeX fonts and map Turkish Unicode chars
% to TeX accent sequences so compilation stays portable.
...
% Turkish babel shorthands (notably ':', '!' and '=') can interfere with packages
% like hyperref; disable them for stable compilation.
